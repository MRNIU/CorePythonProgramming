...
class Retriever(object):
    ...
    def get_file(selfself,url,default="index.html"):
        ...
        if not os.path.dirname(linkdir):
        ...
        for link in r.parse_links():
            ...
            if link not in self.seen:
                if self.dom not in link:
                    print "... idiscarded,not in domain"
                else:
                ...
                print "... discarded,already processded"
